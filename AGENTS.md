...
- `profiles/coco.yaml`: source of truth for built-in route and tool definitions embedded at build time.
...
- Keep route and tool behavior consistent across `profiles/coco.yaml`, CLI adapter output, README route summaries, and e2e tests.
